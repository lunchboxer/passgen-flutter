...
class WordListVerifier {
  ...
  static const Map<String, String> _expectedChecksums = {
    'assets/words.txt': '2bfb213ac8b44ff1ffa55122540270090be1eb9e8d36fc20a3ce7252d33277ea',
    'assets/short-words.txt': '5c4c9fc36b4855d126814286c84b5f3a8220478b1772898f0d1a16605eee1a45',
  };
  ...
  static Future<bool> verifyWordList(String assetPath) async {
    try {
      ...
      if (isValid) {
        ...
        Logger.error('Word list $assetPath verification failed. '
  ...
  static Future<bool> verifyWordListContent(String assetPath) async {
    try {
      ...
      if (duplicateWords.isNotEmpty) {
        Logger.warn('Word list $assetPath contains ${duplicateWords.length} duplicate words');
      ...
      if (shortWords.isNotEmpty) {
        Logger.warn('Word list $assetPath contains ${shortWords.length} words with less than 3 characters');
      ...
      if (nonLowercaseWords.isNotEmpty) {
        Logger.warn('Word list $assetPath contains ${nonLowercaseWords.length} non-lowercase words');
